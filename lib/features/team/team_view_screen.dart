            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  const Spacer(),
                  if (isAdmin && seasonId != null)
                    TextButton.icon(
                      onPressed: () =>
                          _showAddPlayerDialog(context, ref, team, seasonId),
            ...
            ElevatedButton(
              onPressed: saving
                  ...
                  : () async {
                      ...
                      // Generate a simple player ID from name + timestamp
                      ...
                      try {
                        ...
                        if (context.mounted) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(content: Text('$name added to roster')),
                          );
                        }
                      } catch (e) {
                        if (ctx.mounted) {
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              if (assocId != null) {
                await ref
                    .read(statsRepositoryProvider)
                    .removePlayerFromRoster(assocId, compositeId);
              }
              if (ctx.mounted) Navigator.pop(ctx);
              if (context.mounted) {
                ScaffoldMessenger.of(
                  context,
                ).showSnackBar(SnackBar(content: Text('$playerName removed')));
              }
            },
